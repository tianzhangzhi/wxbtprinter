...
*/
  ...
  lanya8:function()
  {
    ...
    wx.writeBLECharacteristicValue({
      deviceId: that.data.connectedDeviceId,//设备deviceId
      serviceId: that.data.writeServicweId,//设备service_id
      characteristicId: that.data.writeCharacteristicsId,//设备write特征值
      value: buffer,//写入数据
      success: function (res) {
        console.log('发送数据:', res.errMsg)
      },
      fail: function () {
        console.log("write fail1");
      },
    })
  },
